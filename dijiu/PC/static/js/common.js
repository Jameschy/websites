...
$(function(){
    $('#school_week').hover(function(){
        $('#school_week').addClass('on');
        $('#school_month').removeClass('on');
        $('#school_week').css('z-index','10');
        $('#school_month').css('z-index','5');
        $('.list-box').eq(0).show();
        $('.list-box').eq(1).hide();
    });
    $('#school_month').hover(function(){
        $('#school_month').addClass('on');
        $('#school_week').removeClass('on');
        $('#school_month').css('z-index','10');
        $('#school_week').css('z-index','5');
        $('.list-box').eq(1).show();
        $('.list-box').eq(0).hide();
    });
});
...
$(function(){
    ...
    var keyChart= nowUrl.split("/")[3];
    $("#mainNav a").removeClass("on");
    $("#inNav li").removeClass("active");
    hotListBox
    $("#hotListBox a").removeClass("cur");
    $("#mainNav a[data-cls="+keyChart+"]").addClass("on");
    $("#inNav li[data-cls="+keyChart+"]").addClass("active");
    $("#hotListBox a[data-cls="+keyChart+"]").addClass("cur");
