...
!function ($, moment) {
    ...
    DateRangePicker.prototype = {
        ...
        move: function () {
            $('.daterangepicker').css('width',this.container.outerWidth());
            $('.daterangepicker').css('height',this.container.outerHeight());
            ...
            if (this.opens == 'left') {
                ...
                if (this.container.offset().top + this.container.outerHeight() > $(window).height()) {
                    this.container.css({
                        top: 'auto',
                        bottom: 0
                    });
